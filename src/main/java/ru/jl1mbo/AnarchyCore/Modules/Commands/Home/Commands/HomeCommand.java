	...
	public boolean execute(CommandSender sender, String label, String[] args) {
		if (sender instanceof Player) {
			...
			if (HomeAPI.isHome(player.getName())) {
				...
				player.teleport(new Position(Integer.parseInt(homeData.get("X")) + 0.5, Integer.parseInt(homeData.get("Y")), Integer.parseInt(homeData.get("Z")) + 0.5, WorldSystemAPI.Map));
