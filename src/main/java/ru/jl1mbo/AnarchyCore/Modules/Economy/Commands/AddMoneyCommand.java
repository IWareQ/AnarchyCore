...
public class AddMoneyCommand extends Command {
	...
	public AddMoneyCommand() {
		...
		this.commandParameters.put("addmoney", new CommandParameter[]{CommandParameter.newType("money", CommandParamType.INT), CommandParameter.newType("player", CommandParamType.TARGET)});
	}
	...
	public boolean execute(CommandSender sender, String label, String[] args) {
		...
		sender.sendMessage(EconomyAPI.PREFIX + "Игрок §6" + targetName + " §fполучил §6" + String.format("%.1f", Double.parseDouble(args[0])) + "");
