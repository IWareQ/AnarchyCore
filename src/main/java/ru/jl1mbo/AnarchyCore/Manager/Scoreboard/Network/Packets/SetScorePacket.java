...
public class SetScorePacket extends DataPacket {
	...
	public boolean equals(final Object o) {
		...
		} else return this$entries.equals(other$entries);
	}
	...
	public static class ScoreEntry {
		...
		@Override()
		public String toString() {
			return "SetScorePacket.ScoreEntry(scoreId=" + this.getScoreId() + ", objective=" + this.getObjective() + ", score=" + this.getScore() + ", entityType=" + this.getEntityType() + ", fakeEntity=" +
				   this.getFakeEntity() + ", entityId=" + this.getEntityId() + ")";
		}
	}
}