package ru.iwareq.anarchycore.manager.Forms;
...
import ru.iwareq.anarchycore.manager.Forms.Forms.CustomFormResponse;
import ru.iwareq.anarchycore.manager.Forms.Forms.Form;
import ru.iwareq.anarchycore.manager.Forms.Forms.ModalFormResponse;
import ru.iwareq.anarchycore.manager.Forms.Forms.SimpleFormResponse;
...
public class FormEventsListener implements Listener {
	...
	public void onPlayerFormResponded(PlayerFormRespondedEvent event) {
		...
		if (Form.playersForm.containsKey(player.getName())) {
			ru.iwareq.anarchycore.manager.Forms.Forms.FormResponse temp = Form.playersForm.get(player.getName());
	...
	public void onPlayerQuit(PlayerQuitEvent event) {
		Form.playersForm.remove(event.getPlayer().getName());
	}
}