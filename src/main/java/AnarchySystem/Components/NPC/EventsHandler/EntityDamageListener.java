...
import AnarchySystem.Components.NPC.EventsHandler.Utils.WanderingTraderHopper;
    ...
    public void onEntityDamage(EntityDamageEvent event) {
        ...
        if (event instanceof EntityDamageByEntityEvent) {
            ...
            if (entity instanceof VillagerNPC) {
                ...
                WanderingTraderHopper traderHopper = new WanderingTraderHopper("§r§l§6Собиратель Артефактов");
                traderHopper.addItem(Item.get(Item.COBWEB, 0, 1).setCustomName("§r§6Паутина Таратнула").setLore("\n§r§fЭтот предмет §7- §6Артефакт§7, §fиспользуй его\nдля обмена с §6Обменщиком Артефактов§7,\n§fкоторый находится на спавне§7!"));
                traderHopper.addItem(Item.get(Item.BLAZE_ROD, 0, 1).setCustomName("§r§6Жезл Солнца").setLore("\n§r§fЭтот предмет §7- §6Артефакт§7, §fиспользуй его\nдля обмена с §6Обменщиком Артефактов§7,\n§fкоторый находится на спавне§7!"));
                traderHopper.addItem(Item.get(Item.ICE_FROSTED, 0, 1).setCustomName("§r§6Льдышка").setLore("\n§r§fЭтот предмет §7- §6Артефакт§7, §fиспользуй его\nдля обмена с §6Обменщиком Артефактов§7,\n§fкоторый находится на спавне§7!"));
                traderHopper.addItem(Item.get(Item.SKULL, 0, 1).setCustomName("§r§6Череп Стража").setLore("\n§r§fЭтот предмет §7- §6Артефакт§7, §fиспользуй его\nдля обмена с §6Обменщиком Артефактов§7,\n§fкоторый находится на спавне§7!"));
