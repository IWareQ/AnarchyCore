...
import AnarchySystem.Manager.Forms.Forms.CustomFormResponse;
import AnarchySystem.Manager.Forms.Forms.Form;
import AnarchySystem.Manager.Forms.Forms.ModalFormResponse;
import AnarchySystem.Manager.Forms.Forms.SimpleFormResponse;
...
public class PlayerFormRespondedListener implements Listener {
    ...
    public void onPlayerFormResponded(PlayerFormRespondedEvent event) {
        ...
        if (Form.playersForm.containsKey(player.getName())) {
            AnarchySystem.Manager.Forms.Forms.FormResponse temp = Form.playersForm.get(player.getName());
