package Anarchy.Module.Commands.ExperienceBottle;

import Anarchy.Module.Commands.ExperienceBottle.Utils.ExperienceBottleChest;
...
public class ExperienceBottleHandler extends Command implements Listener {
	private static String PREFIX = "§l§7(§3Магазин§7) §r";

	public ExperienceBottleHandler() {
		super("eb", "§r§fОбмен опыта");
	...
	public void onPlayerInteract(PlayerInteractEvent event) {
		...
		if (item.getId() == Item.EXPERIENCE_BOTTLE && item.getDamage() > 0) {
