...
public class DonateCommand extends Command {
	...
	public boolean execute(CommandSender sender, String label, String[] args) {
		...
		if (!(sender instanceof Player)) {
			sender.sendMessage("§l§7(§6Система§7) §r§fЭту команду можно использовать только в §6Игре");
			return true;
		}
		new SimpleForm("Описание Донат Услуг", "§l§fЕсли Вас §6устраивает §fлюбая привилегия§7, §fто Вы можете пройти на наш §6сайт §fи приобрести ее§7!\n\n§l§fНаш сайт §7- §6deathmc§7.§6mcpetrade§7.§6ru").addButton("§l§fДля чего нужен Донат§7?").send(
