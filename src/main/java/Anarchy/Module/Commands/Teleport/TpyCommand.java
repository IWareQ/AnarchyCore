...
public class TpyCommand extends Command {
	...
	public boolean execute(CommandSender commandSender, String s, String[] strings) {
		...
		calledPlayer.sendMessage(TpaCommand.PREFIX + "§fИгрок §3" + commandSender.getName() + " §fпринял Ваш запрос§7!");
		commandSender.sendMessage(TpaCommand.PREFIX + "§fЗапрос Игрока §3" + calledPlayer.getName() + " §fпринят§7!");
